...
<html lang="en">
<head>
<title>Enroute | Admin Portal </title>
	<!-- Meta tag Keywords -->
	...
	<nav class="mnu">
		<div class="container">
            <div class="logo" id="logo">
                <h1><a href="index.html">Enroute <b style="color:red">Admin</b></a></h1>
            </div>
	...
	<div class="agile_banner_info">
		<div class="row banner_agile_para">
			<div class="col-lg-9 ban-text">
				<h2>Enroute: <b style="color:red">Admin Backoffice</b></h2>
			</div>	
	...
	<div class="foot_bottom">
		<div class="container">
			<div class="cpy-right text-center py-5">
				...
				<p>© 2019 Enroute Taxi Service App. All rights reserved | Design by
					<a href="http://www.digixpression.net"> digixpression.net.</a>
				</p>
			</div>
		</div>
	</div>
